...
public class EmailController {
    ...
    public void sendMessage() throws MessagingException {
        ...
        ((InternetAddress) address).setAddress("37779654@qq.com");
        MimeMessage mimeMessage = new MimeMessage(session);
        mimeMessage.addRecipients(Message.RecipientType.TO, "71483545@qq.com");//设置收信人
        mimeMessage.addRecipients(Message.RecipientType.CC, "zhangzhiyong1@163.com");//抄送
        ...
        transport.connect("smtp.qq.com", "37779654@qq.com", "zzy19691123wxl");
